...
<p>Bu Uçuşun Verileri Gizlidir</p>
    ...
    <p>{d.aircraft.registration}</p>
        ...
        <p>
        <span>Kalkış:</span>
        <span><a target="_blank" href={d.airport.origin.website}>{d.airport.origin.name} </a></span>
        </p>

        <p>
        <span>Hedef:</span>
        <span><a target="_blank" href={d.airport.destination.website}>{d.airport.destination.name} </a></span>
        </p>
